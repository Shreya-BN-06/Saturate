...
Saturate is a data-driven dashboard that scores India's IT freelance market across 10 major tech hubs and 10 in-demand roles (Python Developer, AI Engineer, Full Stack Developer, UI/UX Designer, Data Scientist, Graphic Designer, Web Developer, Cloud Engineer, Technical Lead, and DevOps Engineer).
For each city-role combination, the project computes a composite Opportunity Score using a custom formula that balances three factors:
